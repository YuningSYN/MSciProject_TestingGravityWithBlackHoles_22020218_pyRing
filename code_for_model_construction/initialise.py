...
to be intended as part of the default value.
       ...
       ***************************************************
               ...
               run-type                   Type of run to be launched. Available options: ['full', 'noise-estimation-only', 'sampling-only', 'post-processing']. Default: 'full'.
               ...
               # inject-EFT                 Flag to inject an EFT-modified waveform. Default: 0.
               ...
               template                   Template to be used in the run. Current available options: ['Damped-sinusoids', 'Kerr', 'MMRDNS', 'MMRDNP', 'KHS_2012', 'TEOBResumSPM', 'IMR-LALModel']. 'LALModel' is any LALSimulation approximant. Default: 'Kerr'.
               ...
               EFT                        Option to activate Effective Field Theory predictions from arXiv:2307.07431. Available options: ['cubic_even', 'cubic_odd', 'quartic_1', 'quartic_2', 'quartic_3']. Default: ''.
       ...
       **************************************************************
               ...
               #================================#
               # Sampler-independent parameters #
               #================================#
               ...
               #==============================#
                ...
                poolsize                     Option to set the number of pools. Default: 128.
                nthreads                     Option to set the number of parallel threads to be used. Default: 1.
                ...
                verbose                      Option to set the output verbosity of the sampler. Available options: FIXME MISSING. Default: 2.
                maxmcmc                      Option to set the number of maximum Markov Chain Monte Carlo steps at each sample (main feature limiting the autocorrelation legth of the samples) to be used by the sampler. Default: 1024.
                nnest                        Number of nested samplers to run in parallel. Default: 1.
                nensemble                    Total number of ensemble processes running. nensemble = nnest * N_ev, where N_ev is the number of live points being substituted at each NS step. Requires N_ev << nlive. Also n_cpu = nnest+nensemble. Default: 1.               
                ...
                resume                       Flag to allow the sampler to resume the run after it was killed. Default: 1.
                logging_interval             The interval in seconds used for periodic logging. If not specified, then periodic logging is disabled. Default: 900
                n_pool                       Number of threads to when for creating the multiprocessing pool. Default: 1
                stopping                     Stop when remaining samples wouldn’t change logZ estimate by this much. Default: 0.1
                plot                         Boolean to toggle plotting. Default: 1
                proposal_plots               Boolean to enable additional plots for the population stage of the sampler. Overwritten by plot. Default: 0
                
                n_blocks                     Number of blocks in the neural network. Default: 4
                n_neurons                    Number of neurons in the neural network. Default: 10
                n_layers                     Number of layers in the neural network. Default: 3
                reset_flow                   Boolean to toggle resetting the entire flow whenever re-training. If an integer is specified the flow is reset every nth time it trains. Default: 0
                volume_fraction              Fraction of the total probability to contain with the latent contour when using a constant volume. Default: 0.95
                
                See nessai's documentation at: https://nessai.readthedocs.io/en/latest/index.html
